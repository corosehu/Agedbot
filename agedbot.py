...
back_kb_builder.row(InlineKeyboardButton(text="⬅️ Back to Main Menu", callback_data="start"))
...
async def start_cmd(msg: types.Message):
    ...
    if uid not in users:
        users.append(uid)
        save_all()
    await msg.answer("Removing old keyboard...", reply_markup=ReplyKeyboardRemove())
    await msg.answer(
