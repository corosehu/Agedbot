...
builder.add(KeyboardButton(text="Browse Products"))
builder.add(KeyboardButton(text="My Orders"))
...
@dp.message(lambda m: m.text == "Browse Products")
...
@dp.message(lambda m: m.text.startswith("PAYMENT"))
...
@dp.message(lambda m: m.text == "My Orders")
