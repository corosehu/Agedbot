...
builder.add(InlineKeyboardButton(text="Browse Products", callback_data="browse"))
builder.add(InlineKeyboardButton(text="My Orders", callback_data="orders"))
builder.add(InlineKeyboardButton(text="Support", callback_data="support"))
...
async def browse(callback: types.CallbackQuery):
    if not products:
        return await callback.message.answer("<b>We're sorry, but there are no products available at the moment.</b>")
...
async def my_orders(callback: types.CallbackQuery):
    ...
    if not my:
        return await callback.message.answer("<b>You have no orders yet.</b>\n\nFeel free to browse our products!")
...
async def support_msg(callback: types.CallbackQuery):
    await callback.message.answer("<b>Need Help?</b>\n\nIf you have any questions or issues, please describe them in a message. Our admin will get back to you as soon as possible.")
